...
<p>Sur ces pages, vous retrouverez plusieurs formulaires permettant de générer les annotations
    automatiquement.<br>
...
<div class="code"><code>class Marque<br> {<br> /**<br> * @ORM\OneToMany(targetEntity="Produit",
        mappedBy="marque")<br>
        */<br> private $produits;</code></div>
<br>

<div class="code lastcode"><code>class Produit<br> {<br> /**<br> * @ORM\ManyToOne(targetEntity="Marque",
        inversedBy="produits")<br> * @ORM\JoinColumn(name="marque_id", referencedColumnName="id")<br> */<br>
        private
        $marque;</code>
</div>
...
<h2>Source</h2>
<p>Documentation officiel de symfony (anglais) : <a href="https://symfony.com/doc/3.4//index.html#gsc.tab=0">symfony.com/doc/3.4</a>
</p>
