...
<div class="code"><code>class Marque<br> {<br> /**<br> * @ORM\OneToMany(targetEntity="Produit", mappedBy="marque")<br>
        */<br> private $produits;</code></div>
<br>
<div class="code lastcode"><code>class Produit<br> {<br> /**<br> * @ORM\ManyToOne(targetEntity="Marque",
        inversedBy="produits")<br> * @ORM\JoinColumn(name="marque_id", referencedColumnName="id")<br> */<br> private
        $marque;</code></div>
</p>
